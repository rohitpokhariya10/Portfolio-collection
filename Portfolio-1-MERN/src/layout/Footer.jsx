    ...
    <>
      ...
      <footer className="border-t-2 border-paper bg-ink py-8 text-paper md:py-10">
        <div className="page-shell">
          ...
          <div
            className="mt-8 grid gap-4 border-t-2 border-paper pt-5 md:grid-cols-[1fr_auto] md:items-center"
            data-reveal
            ...
            <nav className="flex flex-wrap gap-4 md:justify-end">
              {footerLinks.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className="utility-label inline-flex items-center gap-2 underline decoration-paper decoration-2 underline-offset-4 hover:-translate-y-0.5 hover:text-accent-mint"
                >
