        ...
        <div data-reveal style={{ "--reveal-delay": "90ms" }}>
          ...
          <div className="mt-10 grid border-2 border-ink bg-accent-mint md:grid-cols-2">
            {facts.map(([label, value], index) => (
              <div
                key={label}
                className="border-b-2 border-ink p-5 transition-colors duration-200 hover:bg-paper last:border-b-0 md:border-r-2 md:[&:nth-child(even)]:border-r-0 md:[&:nth-last-child(-n+2)]:border-b-0"
                data-reveal
                style={{ "--reveal-delay": `${index * 70 + 160}ms` }}
              >
